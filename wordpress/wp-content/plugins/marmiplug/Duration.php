...
class Duration
{
    ...
    public function meta_render()
    {
        ...
        <label>
            ...
            <input type="number" value="<?= get_post_meta(
                get_the_ID(),
                'marmishlag_recipe_duration'
            )[0] ?>"
    ...
    public function display()
    {
        ...
        $duration =
            isset(
                get_post_meta(get_the_ID(), 'marmishlag_recipe_duration')[0]
            ) &&
            !empty(get_post_meta(get_the_ID(), 'marmishlag_recipe_duration'))
                ? get_post_meta(get_the_ID(), 'marmishlag_recipe_duration')[0]
                : null;
